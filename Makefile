...
#H5FDDSM_DIR=$(HOME)/Documents/KULeuven/NEW_2013_07_15/h5fddsm/h5fddsm-0.9.9/
...
H5FDdsmSender.o: H5FDdsmSender.cxx $(INCLUDE_DIR)/ubx.h $(INCLUDE_DIR)/ubx_types.h $(INCLUDE_DIR)/ubx.c $(HEXARRS)
	${CC} -fPIC -I$(INCLUDE_DIR) -I$(LOCAL_DIR)/include/ -I$(H5FDDSM_DIR)/src -I$(H5FDDSM_DIR)/build/src/ -I$(H5FDDSM_DIR)/Testing/ -I$(KDL_DIR) -c $(CFLAGS) H5FDdsmSender.cxx
